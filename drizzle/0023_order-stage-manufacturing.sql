...
CREATE TYPE "public"."order_stages_name_enum" AS ENUM('review', 'contract_signature', 'payment', 'manufacturing', 'quality_control', 'packaging', 'shipping', 'delivery');--> statement-breakpoint
...
ALTER TABLE "stage_catalog" ALTER COLUMN "key" SET DATA TYPE "public"."order_stages_name_enum" USING "key"::"public"."order_stages_name_enum";